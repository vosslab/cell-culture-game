...
| [LICENSE.LGPL-3.0](../LICENSE.LGPL-3.0)                 | Code license                                                                                                                                                                                      |
| [LICENSE.CC-BY-4.0](../LICENSE.CC-BY-4.0)               | Content license                                                                                                                                                                                   |
...
| `pipeline/object_library_geometry.py`                          | Recorded structured-object subpart geometry and its validated derivation                                                                                                                                                                                                                                     |
...
| [gen_scene_index.py](../pipeline/gen_scene_index.py)           | Strict Scene YAML validation -> `generated/scenes.ts` + `generated/scene_manifest.json`; every emitted scene resolves all SVG assets                                                                                                                                                                         |
| `pipeline/scene_geometry_validation.py`                        | Rejects authored geometry that would bypass layout-engine ownership                                                                                                                                                                                                                                          |
...
| File                                                      | Purpose                                                                                                                                                                                                                          |
| --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `tools/normalize_svg_v3.py`                               | Stable command launcher for the SVG ingestion gate; run before adding any SVG to `assets/`                                                                                                                                       |
| `tools/svg_normalizer/`                                   | Focused SVG ingestion-normalizer package: CLI, document sanitation/classification, geometry, clip/transform flattening, shadow diagnostics, and workflow orchestration                                                           |
...
| `tools/render_svg_library_review.mjs`                     | Builds the intentional shipped `docs/figures/equipment_kit/review.html` gallery from every current authored equipment SVG; it works through `file://` and does not include scene captures                                      |
...
| `tools/svg_census_xml.mjs`                                | Reads the retained equipment SVG tree for exact XML/path reconciliation used by visual-quality review ledgers                                                                                                                    |
...
| [EQUIPMENT_SVG_CONTACT_SHEET.md](EQUIPMENT_SVG_CONTACT_SHEET.md)                       | Historical guide for the pre-consolidation 139-asset contact sheet                                                        |
...
| [figures/final_equipment_contact_sheet.svg](figures/final_equipment_contact_sheet.svg) | Historical self-contained 139-asset equipment review figure                                                               |
...
| `dist/equipment_review.html`                                          | Production-renderer SVG review page copied from `src/equipment_review_template.html`; mounted by `dist/scene_viewer.js` and served over HTTP                                                  |
...
| `docs/figures/equipment_kit/review.html`                              | generated, shipped `file://`-usable current-equipment gallery written by `tools/render_svg_library_review.mjs`; live-links current authored SVGs and contains no scene captures                                                     |
