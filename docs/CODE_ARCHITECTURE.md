...
| `tools/liquid_volume_contact_page.mjs`                              | Developer visual gate that serializes real compiled-liquid runtime output into a self-contained volume contact HTML page and PNG under `rendered-reports/liquid_volume_contacts/`; root `render_liquid_volume_contact_sheet.sh` rebuilds and renders the complete five-family sheet in one step |
