...
current ownership-repaired tree contains 130 authored SVGs.

Use the current [production-art review workflow](USAGE.md#equipment-svg-visual-review)
to build the searchable 130-source page, then judge scene appearance through
...
![Historical labeled contact sheet of the former 139-asset equipment SVG tree](figures/final_equipment_contact_sheet.svg)
