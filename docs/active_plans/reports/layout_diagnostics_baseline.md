...
- Generated: 2026-08-03 14:16 UTC
- Scenes scanned: 42
...
| 3 | `centrifuge_workspace` | 130 | item_escapes_zone_vertically=13 |
| 4 | `imaging_bench` | 121 | item_escapes_zone_vertically=12, label_row_staggered=1 |
| 5 | `heat_block_bench` | 120 | item_escapes_zone_vertically=12 |
| 6 | `sample_prep_bench` | 110 | item_escapes_zone_vertically=11 |
| 7 | `staining_bench` | 100 | item_escapes_zone_vertically=10 |
| 8 | `bench_basic` | 90 | item_escapes_zone_vertically=9 |
| 9 | `cell_counter_workspace` | 80 | item_escapes_zone_vertically=8 |
| 10 | `dilution_workspace` | 80 | item_escapes_zone_vertically=8 |
| 11 | `mtt_reagent_prep_bench_workspace` | 80 | item_escapes_zone_vertically=8 |
| 12 | `cell_counter_basic` | 70 | item_escapes_zone_vertically=7 |
| 13 | `drug_dilution_setup_bench_setup` | 70 | item_escapes_zone_vertically=7 |
| 14 | `hemocytometer_view` | 70 | item_escapes_zone_vertically=7 |
| 15 | `extraction_workspace` | 60 | item_escapes_zone_vertically=6 |
| 16 | `passage_hood_detachment_hood_workspace` | 60 | item_escapes_zone_vertically=6 |
| 17 | `sdspage_destain_gel_setup_workspace` | 60 | item_escapes_zone_vertically=6 |
| 18 | `sdspage_stain_gel_workspace` | 60 | item_escapes_zone_vertically=6 |
| 19 | `seeding_workspace` | 60 | item_escapes_zone_vertically=6 |
| 20 | `sdspage_prepare_sample_mix_single_lane_workspace` | 51 | item_escapes_zone_vertically=5, label_row_staggered=1 |
| 21 | `hood_basic` | 50 | item_escapes_zone_vertically=5 |
| 22 | `incubator_workspace` | 50 | item_escapes_zone_vertically=5 |
| 23 | `microscope_basic` | 50 | item_escapes_zone_vertically=5 |
| 24 | `plate_workspace` | 50 | item_escapes_zone_vertically=5 |
| 25 | `sdspage_load_protein_ladder_workspace` | 50 | item_escapes_zone_vertically=5 |
| 26 | `hood_workspace` | 40 | item_escapes_zone_vertically=4 |
...
| 29 | `sdspage_prepare_sample_mix_batch_workspace` | 40 | item_escapes_zone_vertically=4 |
...
| 33 | `sdspage_load_sample_single_lane_workspace` | 30 | item_escapes_zone_vertically=3 |
| 34 | `sdspage_load_samples_batch_workspace` | 30 | item_escapes_zone_vertically=3 |
| 35 | `sdspage_recycle_buffer_workspace` | 30 | item_escapes_zone_vertically=3 |
| 36 | `sdspage_run_electrophoresis_workspace` | 30 | item_escapes_zone_vertically=3 |
...
| `passage_hood_detachment_hood_workspace` | 10 |
| `passage_hood_detachment_microscope_view` | 6 |
| `plate_drug_treatment_media_adjustment_plate_workspace` | 4 |
| `plate_focus_bench` | . |
| `plate_focus_hood` | . |
| `plate_workspace` | 6 |
| `sample_prep_bench` | . |
