...
import validation.yaml_schema.protocol_interaction_validation


class ProtocolValidator(validation.yaml_schema.protocol_interaction_validation.ProtocolInteractionValidationMixin):
	"""Validates protocol YAML files per PRIMARY_SPEC.md with Tier 1 cross-file checks."""

	def __init__(self, db: ContentDatabase | None = None) -> None:
